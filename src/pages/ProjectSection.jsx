  ...
  return (
    <div className="text-white mt-20 md:mt-0 w-[90%] mx-auto">
      ...
      <div className="mt-20 md:mt-0 space-y-10 md:space-y-0 md:p-20 flex justify-around flex-wrap">
        ...
        <ProjectCard
          imageLink="/Images/wifi.jpg"
          title="WiFi QR Code Generator"
          description="Generate and scan WiFi QR codes using HTML, CSS and JavaScript."
          github="https://github.com/ArpitTripathi798/Wifi-QR-Code"
          liveDemo="https://wifi-qr-code-five.vercel.app"
        />
